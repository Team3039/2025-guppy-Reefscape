...
// APTarget target = new APTarget(REEF_F)
...
// }
 ...
 public static final class AutopilotConstants {
    // Motion constraints for acceleration and jerk
    private static final APConstraints kConstraints = new APConstraints()
        .withAcceleration(5.0) // m/s^2
        .withJerk(2.0);        // m/s^3

    // Autopilot profile with tolerances
    private static final APProfile kProfile = new APProfile(kConstraints)
        .withErrorXY(Centimeters.of(2))            // XY tolerance (e.g. 2cm)
        .withErrorTheta(Degrees.of(0.5))           // Angular tolerance (0.5 deg)
        .withBeelineRadius(Centimeters.of(8));     // How tightly to curve to target

    // Singleton instance of Autopilot
    public static final Autopilot kAutopilot = new Autopilot(kProfile);
  }
  ...
  // Red branch poses
// I will add these soon trust me bro

...
public class Elevator extends SubsystemBase {
	...
	public TalonFX climbA = new TalonFX(TunerConstants.Elevator);
	...
	public void setClimbClosedLoop() {
		...
		output = controller.calculate(encoder.getPosition(), setpointClimb) + TunerConstants.Elevator.CLIMB_KS;
